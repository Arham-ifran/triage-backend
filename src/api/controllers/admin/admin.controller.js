...
exports.dashboard = async (req, res, next) => {
    try {
        ...
        const wallets = await Wallets.countDocuments({})
        const faqs = await FAQ.countDocuments({})
        const promos = await PromoCodes.countDocuments({})
        return res.send({
            success: true,
            message: 'Stats fetched successfully',
            data: {
                users, wallets, faqs, promos
            }
        })
    } catch (error) {
        return next(error)
...
var privateAdminPermissionsKeys = {
    ...
    // AccountTier
    'addAccountTier': true,
    'editAccountTier': true,
    'deleteAccountTier': true,
    'viewAccountTier': true,
    ...
    // ReceiveStaking   
    'editReceiveStaking': true,
    'viewReceiveStaking': true,
    ...
    // Delete Request 
    'editRequestDeletion': true,
    'deleteRequestDeletion': true,
    'viewRequestDeletion': true,
